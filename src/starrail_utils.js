...
export const characters = {
  "翡翠": {
    ...
    ace: 235,
    badge: 'https://act-upload.mihoyo.com/sr-wiki/2024/07/10/279865110/1ed0169935f053efc2f9aefbe0ba536d_4387535538324380493.png',
    artifacts: [
      {
        setNames: [GeniusofBrilliantStars, '无主的荒星茨冈尼亚'],
        head: ["hp"],
        hands: ["atk"],
  ...
  "银枝": {
    ...
    ace: 225,
    badge: 'https://act-upload.mihoyo.com/sr-wiki/2024/07/10/279865110/93cefb9644d803d6887591c0a3026109_8389936285995750458.png',
    artifacts: [
      {
  ...
  "暴击c·占位": {
    ...
    artifacts: [
      {
        setNames: Object.entries(artifactIcons).filter(([key, { head }]) => head).map(([key]) => key).concat([RutilantArena, InertSalsotto, FirmamentFronlineGlamoth, "出云显世与高天神国", "无主的荒星茨冈尼亚", GeniusofBrilliantStars, '奔狼的都蓝王朝']),
        head: ["hp"],
        hands: ["atk"],
        body: ["critRate", "critDMG"],
        feet: ["atk", "spd"],
